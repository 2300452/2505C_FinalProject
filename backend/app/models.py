...
class Consultation(Base):
    ...
    tosp_codes_json = Column(Text, nullable=True)
    bill_provider_email = Column(String(150), nullable=True)
    bill_status = Column(String(50), nullable=True)
    bill_sent_at = Column(DateTime(timezone=True), nullable=True)
    patient_bill_status = Column(String(50), nullable=True)
    patient_bill_alert_sent_at = Column(DateTime(timezone=True), nullable=True)
    patient_bill_paid_at = Column(DateTime(timezone=True), nullable=True)
    created_at = Column(DateTime(timezone=True), server_default=func.now())
